	...
	<tr>
		<td>
			<table border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					<td>
						<form action="<?php echo(_set_link_(def_application_pemakai, "process=delete&processid=" . $HTTP_GET_VARS["processid"] . "&action=true")); ?>" method="post">
							<table border="0" cellpadding="3" cellspacing="0" align="center" class="myform">
								...
								<tr>
									...
									<td align="left">
										<?php echo(_set_label_("", $var_class_pemakai->var_username)); ?>
									</td>
								</tr>
								<tr>

			...
			<table border="1" cellpadding="5" cellspacing="0" class="myform">
				<tr>
					<td colspan="2" align="left" class="mycaption">
						<?php echo(_set_label_("", "SELAMAT DATANG,")); ?>
					</td>
				</tr>
				<tr>
					<td valign="top">
						<form action="<?php echo(_set_link_(def_application_login, "process=login")); ?>" method="post">
							<table border="0" cellpadding="3" cellspacing="0">
								...
								<tr>
									<td>&nbsp;</td>
									<td align="left">
										<?php echo(_set_hyperlink_(def_application_forget, "Lupa Password?")); ?>
									</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td align="left">
										<?php echo(_set_hyperlink_(def_application_signup, "Registrasi")); ?>
									</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
